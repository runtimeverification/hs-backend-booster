...
test_patternSynonyms =
    testGroup
        ...
        [testPatternAndBool, testPatternNotBool, testPatternEqualsBool, testPatternEqualsInt, testPatternNEqualsInt, testPatternEqualsK, testPatternNEqualsK, testPatternSetIn]

testPatternAndBool :: TestTree
testPatternAndBool =
    testCase "_andBool_" $
        let parsedSymbol = [symb| hooked-symbol Lbl'Unds'andBool'Unds'{}(SortBool{}, SortBool{}) : SortBool{} [bfunction{}(), functional{}(), hook{}("BOOL.and"), smt-hook{}("and"), total{}()] |]
...
testPatternEqualsBool =
    testCase "_==Bool_" $
        let parsedSymbol = [symb| hooked-symbol Lbl'UndsEqlsEqls'Bool'Unds'{}(SortBool{}, SortBool{}) : SortBool{} [comm{}(), format{}("%1 %c==Bool%r %2"), function{}(), functional{}(), hook{}("BOOL.eq"), klabel{}("_==Bool_"), left{}(Lbl'UndsEqlsSlshEqls'Bool'Unds'{}(),Lbl'UndsEqlsEqls'Bool'Unds'{}()), org'Stop'kframework'Stop'attributes'Stop'Location{}("Location(1108,19,1108,126)"), org'Stop'kframework'Stop'attributes'Stop'Source{}("Source(/home/jost/work/RV/code/evm-semantics-with-deps/.build/usr/lib/kevm/kframework/include/kframework/builtin/domains.md)"), priorities{}(), right{}(), smt-hook{}("="), symbol'Kywd'{}(), terminals{}("010"), total{}()] |]
            appliedParsedSymbol = SymbolApplication parsedSymbol [] [TrueBool, TrueBool]
         in case appliedParsedSymbol of
...
testPatternEqualsInt =
    testCase "_==Int_" $
        let parsedSymbol = [symb| hooked-symbol Lbl'UndsEqlsEqls'Int'Unds'{}(SortInt{}, SortInt{}) : SortBool{} [comm{}(), format{}("%1 %c==Int%r %2"), function{}(), functional{}(), hook{}("INT.eq"), klabel{}("_==Int_"), latex{}("{#1}\\mathrel{{=}{=}_{\\scriptstyle\\it Int}}{#2}"), left{}(), org'Stop'kframework'Stop'attributes'Stop'Location{}("Location(1308,19,1308,173)"), org'Stop'kframework'Stop'attributes'Stop'Source{}("Source(/home/jost/work/RV/code/evm-semantics-with-deps/.build/usr/lib/kevm/kframework/include/kframework/builtin/domains.md)"), priorities{}(), right{}(), smt-hook{}("="), symbol'Kywd'{}(), terminals{}("010"), total{}()] |]
...
testPatternNEqualsInt =
    testCase "_=/=Int_" $
        let parsedSymbol = [symb| hooked-symbol Lbl'UndsEqlsSlshEqls'Int'Unds'{}(SortInt{}, SortInt{}) : SortBool{} [comm{}(), format{}("%1 %c=/=Int%r %2"), function{}(), functional{}(), hook{}("INT.ne"), klabel{}("_=/=Int_"), latex{}("{#1}\\mathrel{{=}{/}{=}_{\\scriptstyle\\it Int}}{#2}"), left{}(), org'Stop'kframework'Stop'attributes'Stop'Location{}("Location(1309,19,1309,184)"), org'Stop'kframework'Stop'attributes'Stop'Source{}("Source(/home/jost/work/RV/code/evm-semantics-with-deps/.build/usr/lib/kevm/kframework/include/kframework/builtin/domains.md)"), priorities{}(), right{}(), smt-hook{}("distinct"), symbol'Kywd'{}(), terminals{}("010"), total{}()] |]
            appliedParsedSymbol = SymbolApplication parsedSymbol [] [dvInt "1", dvInt "1"]
